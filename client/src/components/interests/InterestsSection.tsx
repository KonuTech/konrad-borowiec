...
// Cycling image
const cyclingImages = [
  "/images/cycling/IMG_20220713_171341.jpg"
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
          ...
          >
            ...
            <div className="bg-white dark:bg-portfolio-dark p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              <h3 className="font-nunito font-bold text-xl mb-4 text-portfolio-primary dark:text-portfolio-lighter">History, Architecture & Economics</h3>
              <p className="mb-4 text-portfolio-text dark:text-portfolio-lighter/90">
                I have a profound interest in history, architecture, and economics, which greatly influences how I explore the world. Learning about different civilizations, 
                their architectural achievements, and economic systems helps me understand the evolution of human society and culture.
              </p>
              <p className="text-portfolio-text dark:text-portfolio-lighter/90">
                These interests are actually the driving forces behind my motorcycle road trips and cycling adventures. They allow me to directly experience historical sites, 
