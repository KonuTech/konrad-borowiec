...
export const TECHNOLOGIES: Technology[] = [
  ...
  { id: 'jinja2', label: 'Jinja2', aliases: ['Jinja2', 'Jinja'], isSkill: false },
  ...
  { id: 'pgadmin', label: 'pgAdmin', aliases: ['pgAdmin'], isSkill: false },
  {
    id: 'scikit-learn',
    label: 'scikit-learn',
    aliases: ['scikit-learn', 'Sciki-learn', 'sciki-learn'],
    isSkill: false,
  },
  { id: 'pandas', label: 'Pandas', aliases: ['Pandas'], isSkill: false },
  { id: 'xgboost', label: 'XGBoost', aliases: ['XGBoost'], isSkill: false },
  { id: 'tensorflow', label: 'TensorFlow', aliases: ['TensorFlow'], isSkill: false },
  { id: 'mlflow', label: 'MLflow', aliases: ['MLflow'], isSkill: false },
  { id: 'prefect', label: 'Prefect', aliases: ['Prefect'], isSkill: false },
  { id: 'evidently', label: 'Evidently AI', aliases: ['Evidently AI'], isSkill: false },
  { id: 'fastapi', label: 'FastAPI', aliases: ['FastAPI'], isSkill: false },
  { id: 'flask', label: 'Flask', aliases: ['Flask'], isSkill: false },
  { id: 'streamlit', label: 'Streamlit', aliases: ['Streamlit'], isSkill: false },
  { id: 'kafka', label: 'Kafka', aliases: ['Apache Kafka', 'Kafka'], isSkill: false },
  {
    id: 'spark',
    label: 'Spark Structured Streaming',
    aliases: ['Spark Structured Streaming', 'Spark'],
    isSkill: false,
  },
  { id: 'elasticsearch', label: 'Elasticsearch', aliases: ['Elasticsearch'], isSkill: false },
  { id: 'grafana', label: 'Grafana', aliases: ['Grafana'], isSkill: false },
  { id: 'kubernetes', label: 'Kubernetes', aliases: ['Kubernetes', 'k8s'], isSkill: false },
  { id: 'kind', label: 'Kind', aliases: ['Kind cluster'], isSkill: false },
  { id: 'gcp', label: 'Google Cloud Platform', aliases: ['GCP'], isSkill: false },
  { id: 'react', label: 'React', aliases: ['React'], isSkill: false },
  { id: 'typescript', label: 'TypeScript', aliases: ['TypeScript'], isSkill: false },
  { id: 'javascript', label: 'JavaScript', aliases: ['JavaScript'], isSkill: false },
  { id: 'nodejs', label: 'Node.js', aliases: ['Node.js'], isSkill: false },
  { id: 'tailwind', label: 'Tailwind CSS', aliases: ['Tailwind CSS', 'Tailwind'], isSkill: false },
