...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Dockerized Flask service - scoring if a customer will default. Pandas, Sciki-learn, XGBoost, Flask, Docker',
...
export const books: Book[] = [
  ...
  },
  {
    id: 2,
    title:
      'Data Engineering with dbt. A practical guide to building a claud-based, programatic, and dependabe data platform with SQL.',
  ...
  },
  {
    id: 3,
    title:
      'Data Engineering with Databricks Cookbook. Build effective data and AI solutions using Apacher Spark, Databricks, and Delta Lake.',
    author: 'Navdeep Ghai',
  ...
  },
  {
    id: 4,
    title:
      'Data Engineering with Google Cloud Platform. A guide to leveling up as a data engineer by building scalable data platforms with Google Cloud.',
    author: 'Adi Wijaya',
  ...
  },
  {
    ...
    author: 'Matt Palmer',
    coverUrl:
      '/pictures/readings/understanding-etl-data-pipelines-for-modern-data-architecture.jpg',
    genre: 'Data Engineering',
    status: 'read',
  },
  {
  ...
  },
  {
    id: 9,
    title:
      'Fundamentals of Analytics Engineering. An introduction to building end-to-end analytics solutuions.',
    author:
      'Dumky De Wilde, Fanny Kassapian, Jovan Gligorevic, Juan Manuel Perafan, Lasse Benninga, Ricardo Angel Granados Lopez, Taís Laurindo Pereira',
  ...
  },
  {
    id: 10,
    title:
      'The Definitive Guide to Data Integraition. Unlock the power of data integration to effectively manage, transform, and analyze data.',
  ...
  },
  {
    id: 11,
    title:
      'Polars Cookbook. Over 60 recipes to transfer, manipulate, and analyze your data using Python Polars 1.x.',
  ...
  },
  {
    id: 12,
    title:
      'Getting Stared with DuckDB. A practical guide for accelerating your data science, data analytics, and data engineering workflows.',
  ...
  },
  {
    id: 13,
    title:
      'Data Engineering Best Practices. Architect robust and cost-effective data solutions in the cloude era.',
