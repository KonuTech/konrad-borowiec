...
export const BOOK_GENRE_COLORS = {
  "self-improvement": "bg-ghibli-lightPink text-ghibli-pink",
  "sci-fi": "bg-ghibli-lightBlue text-ghibli-blue",
  "programming": "bg-ghibli-purple/20 text-ghibli-purple",
  "history": "bg-ghibli-peach/50 text-amber-700",
